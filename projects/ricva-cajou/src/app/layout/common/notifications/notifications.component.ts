...
export class NotificationsComponent implements OnInit, OnDestroy {
  ...
  classNotif: string =
    'mat-focus-indicator rounded-xl mat-flat-button mat-button-base';
  ...
  private _calculateUnreadCount(): void {
    ...
    if (this.unreadCount > 0) {
      this.classNotif =
        'mat-focus-indicator btn-notifications bg-blue-tint text-white rounded-xl mat-flat-button mat-button-base';
    }
  }
}
