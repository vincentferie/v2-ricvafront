...
export class AnalyticsComponent implements OnInit, OnDestroy {
  chartVisitors: ApexOptions | any;
  chartConversions: ApexOptions | any;
  chartImpressions: ApexOptions | any;
  chartVisits: ApexOptions | any;
  chartVisitorsVsPageViews: ApexOptions | any;
  chartNewVsReturning: ApexOptions | any;
  chartGender: ApexOptions | any;
  chartAge: ApexOptions | any;
  chartLanguage: ApexOptions | any;
  data: any;
  ...
  private _prepareChartData(): void {
    ...
    this.chartConversions = {
      ...
      yaxis: {
        labels: {
          formatter: (val: string): string => val.toString(),
        },
      },
    };
