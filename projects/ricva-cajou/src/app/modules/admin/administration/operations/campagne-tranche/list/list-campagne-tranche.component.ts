...
@Component({
  selector: 'app-list-campagne-tranche',
  templateUrl: './list-campagne-tranche.component.html',
  styleUrls: ['./list-campagne-tranche.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  animations: fuseAnimations,
})
export class ListCampagneTrancheComponent implements OnInit {
  ...
  campagnes$: Observable<CampagneTranche[]>;
  campagnes: CampagneTranche[] = [];

  private _unsubscribeAll: Subject<any> = new Subject<any>();

  headers = [
    { value: 'libelle', label: 'Libellé', name: 'Libellé', class: 'w-40 hidden lg:block'},
    { value: 'outturn_min', label: 'Outturn min', name: 'Outturn minimum', class: 'w-20'},
    { value: 'outturn_max', label: 'Outturn max', name: 'Outturn maximum', class: 'w-20'},
    { value: 'dateD', label: 'Date début', name: 'Date de début', class: 'w-30 hidden lg:block'},
    { value: 'dateF', label: 'Date fin', name: 'Date de fin', class: 'w-30 hidden sm:block'},
  ];
  paths = [
    { label: 'Tableau de bord', range: 'first' },
    { label: 'Administration', range: null },
    { label: 'Historique des campagnes tranche', range: 'last' },
  ];
  ...
  toggleCreation() {
    this.router.navigate(['/administration/operations/campagne/tranche/new']);
  }
   ...
   * @param Id
   */
   toggleDetails(campagne: CampagneTranche): void {
    ...
    this.router.navigate(['/administration/operations/campagne/tranche/detail']);
  }
