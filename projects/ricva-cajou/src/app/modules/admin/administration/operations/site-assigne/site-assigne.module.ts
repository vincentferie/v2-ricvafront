...
import { siteAssigneRoutes } from './site-assigne.routing';
...
@NgModule({
  declarations: [
    SiteAssigneComponent,
    ListSiteAssigneComponent,
    CreationSiteAssigneComponent,
    DetailSiteAssigneComponent,
  ],
  imports: [
    RouterModule.forChild(siteAssigneRoutes),
...
export class SiteAssigneModule {}
