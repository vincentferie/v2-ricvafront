...
@Component({
  selector: 'app-list-campagne-outturn',
  templateUrl: './list-campagne-outturn.component.html',
  styleUrls: ['./list-campagne-outturn.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  animations: fuseAnimations,
})
export class ListCampagneOutturnComponent implements OnInit {
  ...
  campagnes$: Observable<CampagneOutturn[]>;
  campagnes: CampagneOutturn[] = [];

  private _unsubscribeAll: Subject<any> = new Subject<any>();

  headers = [
    { value: 'speculation', label: 'Spéculation', name: 'Spéculation', class: 'w-40'},
    { value: 'campagne', label: 'Campagne', name: 'Campagne', class: 'w-30'},
    { value: 'flag', label: 'Flag', name: 'Flag', class: 'w-30 hidden lg:block'},
    { value: 'min', label: 'Min outturn', name: 'Min outturn', class: 'w-20'},
    { value: 'max', label: 'Max outturn', name: 'Max outturn', class: 'w-20 hidden lg:block'},
  ];
  paths = [
  ...
  toggleCreation() {
    this.router.navigate(['/administration/operations/campagne/outturn/new']);
  }
   ...
   * @param Id
   */
   toggleDetails(campagne: CampagneOutturn): void {
    ...
    this.router.navigate(['/administration/operations/campagne/outturn/detail']);
  }
