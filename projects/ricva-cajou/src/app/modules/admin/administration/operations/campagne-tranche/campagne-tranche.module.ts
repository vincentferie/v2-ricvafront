...
import { campagneTrancheRoutes } from './campagne-tranche.routing';
...
@NgModule({
  declarations: [
    CampagneTrancheComponent,
    CreationCampagneTrancheComponent,
    ListCampagneTrancheComponent,
    DetailCampagneTrancheComponent,
  ],
  imports: [
    RouterModule.forChild(campagneTrancheRoutes),
