...
import { entrepotAssigneRoutes } from './entrepot-assigne.routing';
...
@NgModule({
  declarations: [
    EntrepotAssigneComponent,
    ListEntrepotAssigneComponent,
    CreationEntrepotAssigneComponent,
    DetailEntrepotAssigneComponent,
  ],
  imports: [
    RouterModule.forChild(entrepotAssigneRoutes),
...
export class EntrepotAssigneModule {}
