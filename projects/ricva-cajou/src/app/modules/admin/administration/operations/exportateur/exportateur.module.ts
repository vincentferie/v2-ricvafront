...
import { exportateurRoutes } from './exportateur.routing';
...
@NgModule({
  declarations: [
    ExportateurComponent,
    ListExportateurComponent,
    CreationExportateurComponent,
    DetailExportateurComponent,
  ],
  imports: [
    RouterModule.forChild(exportateurRoutes),
...
export class ExportateurModule {}
