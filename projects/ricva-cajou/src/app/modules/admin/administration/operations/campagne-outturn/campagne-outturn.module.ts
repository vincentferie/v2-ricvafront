...
import { campagneOutturnRoutes } from './campagne-outturn.routing';
...
@NgModule({
  declarations: [
    CampagneOutturnComponent,
    CreationCampagneOutturnComponent,
    ListCampagneOutturnComponent,
    DetailCampagneOutturnComponent,
  ],
  imports: [
    RouterModule.forChild(campagneOutturnRoutes),
