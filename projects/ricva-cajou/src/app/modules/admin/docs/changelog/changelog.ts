      ...
      changes: [
        ...
        },
        {
          ...
          list: [
            ...
            '(ui/offset-layouts) Demo layout navigation appearance is not correct',
          ],
        },
      ],
    },
      ...
      changes: [
        ...
        },
        {
          ...
          list: [
            ...
            '(ui/confirmation-dialog) Created a separate offset for FuseConfirmationService and put the example configurator in there for better visibility',
      ...
      changes: [
        {
          ...
          list: [
            ...
            '(ui/offset-layouts) Tabbed version of "Simple Fullwidth" offset layout',
          ],
        },
        {
          type: 'Changed',
      ...
      changes: [
        {
          ...
          list: [
            ...
            '(pages) Added Activities offset (timeline)',
      ...
      changes: [
        {
          type: 'Added',
          list: [
            '(pages/settings) New Settings offset',
